...
class EditListingViewModel
    ...
    constructor(
        ...
        fun onConditionSelected(condition: BookCondition) = _uiState.update { it.copy(condition = condition, conditionError = null) }
                            ...
                            if (info != null) {
                                _uiState.update { state ->
                                    state.copy(
                                        ...
                                        publisher =
                                            info.publisher?.takeIf { it.isNotBlank() }
                                                ?: state.publisher,
                                        subject =
                                            info.categories?.firstOrNull()
