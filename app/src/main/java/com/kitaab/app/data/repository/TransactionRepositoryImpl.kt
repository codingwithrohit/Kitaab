...
class TransactionRepositoryImpl @Inject constructor(
    ...
    override suspend fun getTransactionForConversation(
    ...
    override suspend fun createTransaction(
        ...
        val handoffCode = if (handoffMethod == "PORTER") {
            generateHandoffCode()
        } else null
    ...
    override suspend fun raiseDispute(transactionId: String): Result<Unit> = runCatching {
        supabase.postgrest["transactions"]
