...
interface TransactionRepository {
    ...
    suspend fun confirmByCurrentUser(transactionId: String, isSeller: Boolean): Result<Transaction>

    suspend fun uploadPackedPhoto(transactionId: String, photoBytes: ByteArray): Result<String>
